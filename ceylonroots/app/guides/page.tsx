...
const ALL_EXPERTISE = ['Wildlife', 'Cultural', 'Photography', 'Adventure', 'History', 'Beach', 'Hiking', 'Birdwatching'];
...
export default function GuidesPage() {
    ...
    const filtered = guides.filter(g => {
        ...
        const matchExpertise = !selectedExpertise || g.expertise.includes(selectedExpertise);
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-gradient-to-r from-ceylon-stone to-ceylon-tea text-white py-14 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    <div className="flex items-center justify-center gap-3 mb-3">
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold">Meet Your Local Guides</h1>
                    </div>
                    <p className="text-white/80 max-w-xl mx-auto text-sm md:text-base">
                        Our handpicked specialists know Sri Lanka intimately — from its hidden temples to secret wildlife trails. Every guide is vetted, passionate, and local.
                    </p>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center gap-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        {ALL_EXPERTISE.map(e => (
                            <button
                                key={e}
                                onClick={() => setSelectedExpertise(selectedExpertise === e ? null : e)}
            ...
            <div className="max-w-7xl mx-auto px-4 py-10">
                {loading ? (
                    ...
                    <>
                        <p className="text-sm text-gray-500 mb-6">{filtered.length} guide{filtered.length !== 1 ? 's' : ''} available</p>
