  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-card rounded-xl shadow-xl w-full max-w-md">
        <div className="p-6">
          <h2 className="text-2xl font-bold text-ceylon-stone mb-2">
            Request a Quotation
          </h2>
          <p className="text-muted-foreground mb-6">
            Please enter your email address to receive your customized travel
            package quote.
          </p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:ring focus:ring-ceylon-tea/50 bg-background text-foreground ${
                  isValidEmail ? "border-border" : "border-red-500"
                }`}
