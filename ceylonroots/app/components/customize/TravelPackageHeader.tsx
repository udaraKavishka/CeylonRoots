...
const TravelPackageHeader: React.FC<TravelPackageHeaderProps> = ({
  duration,
  totalCost,
}) => {
  return (
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="flex-1">
            ...
            <p className="text-lg text-ceylon-sand-light max-w-2xl">
              Select and arrange components to build your perfect travel
              itinerary
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 min-w-[140px] border border-ceylon-sand/30">
              <p className="text-xs uppercase tracking-wider text-ceylon-sand-light mb-1">
                Duration
              </p>
              <div className="flex items-baseline">
                ...
                <span className="text-ceylon-sand-light ml-1">
                  {duration === 1 ? "Day" : "Days"}
                </span>
              </div>
            </div>
