...
export const allDestinations: DestinationDetails[] = [
  {
    ...
    name: "Sigiriya",
    description:
      "Sigiriya, also known as the Lion Rock, is an ancient rock fortress and palace ruins situated in the central Matale District. This UNESCO World Heritage site was built by King Kasyapa and features stunning frescoes, water gardens, and the famous Lion Gate.",
    ...
    culturalTips:
      "Dress modestly when visiting religious sites. Remove shoes before entering temples. Always ask for permission before taking photos of locals.",
    attractions: [
  ...
  },
  {
    ...
    culturalTips:
      "The Temple of the Tooth Relic is one of the most sacred Buddhist sites. Proper attire (covering shoulders and knees) is required. The annual Esala Perahera festival in July/August is a spectacular cultural event.",
    attractions: [
  ...
  },
  {
    ...
    name: "Galle",
    description:
      "Galle is a major city located on the southwestern tip of Sri Lanka. It's known for Galle Fort, the fortified old city founded by Portuguese colonists in the 16th century. The city boasts a unique blend of European architecture and South Asian traditions.",
    ...
    culturalTips:
      "Galle has a rich multicultural history with Dutch, Portuguese, British and indigenous influences. The locals are used to tourists but still appreciate respectful behavior.",
    attractions: [
      "Galle Fort",
  ...
  },
  {
    ...
    name: "Ella",
    description:
      "Ella is a small town in the Badulla District of Uva Province, Sri Lanka. It's situated in the middle of beautiful countryside with tea plantations, waterfalls, and panoramic views. The area has a cooler climate than surrounding lowlands, due to its elevation.",
    region: "Hill Country",
    image: "/images/home/img1.jpg",
  ...
  },
  {
    ...
    description:
      "Yala National Park is Sri Lanka's most famous wildlife park, located in the southeast region of the country. It's home to 44 varieties of mammals and 215 bird species, but is best known for having one of the highest leopard densities in the world.",
    ...
    recommendedDuration: "1-2 days",
    culturalTips:
      "Always follow the guide's instructions. Don't make loud noises during safaris. Never feed the animals. Photography is allowed but be respectful of wildlife.",
    attractions: [
      "Leopard safaris",
      "Elephant watching",
      "Bird watching",
  ...
  },
  {
    ...
    name: "Anuradhapura",
    description:
      "Anuradhapura is one of the ancient capitals of Sri Lanka, famous for its well-preserved ruins of an ancient Sinhala civilization. The city, now a UNESCO World Heritage site, was the center of Theravada Buddhism for many centuries.",
    region: "Cultural Triangle",
    image: "/images/home/img1.jpg",
    ...
    recommendedDuration: "2 days",
    culturalTips:
      "This is a sacred city for Buddhists. Dress appropriately (covered shoulders and knees) and remove hats and shoes when entering temples. Photography is allowed in most places but confirm before taking pictures.",
    attractions: [
      "Sri Maha Bodhi",
      "Ruwanwelisaya Stupa",
      "Jetavanaramaya",
