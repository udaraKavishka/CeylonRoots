...
export const travelPackages: TravelPackage[] = [
  ...
  },
  {
    ...
    description:
      "Immerse yourself in Sri Lanka's biodiversity with safaris in premier national parks and exploration of UNESCO-listed rainforests, featuring elephants, leopards and endemic species.",
    image: "/images/home/img1.jpg",
    duration: 6,
    price: 949,
    rating: 4.9,
    ...
    itinerary: [
      {
        ...
        location: "Udawalawe",
        description:
          "Airport pickup and scenic drive to Udawalawe. Evening orientation and nature documentary screening.",
        accommodation: "Grand Udawalawe Safari Resort",
        meals: "Dinner",
      ...
      },
      {
        ...
        location: "Sinharaja",
        description:
          "Transfer to Sinharaja UNESCO Biosphere. Guided trek through primary rainforest with endemic species spotting.",
      ...
      },
      {
        ...
        location: "Kitulgala",
        description:
          "River tubing and rainforest canopy walk. Afternoon visit to local village and spice garden.",
      ...
      },
      {
        ...
        location: "Yala",
        description:
          "Full day safari in Yala with picnic lunch. Focus on leopard habitats and wetland birds.",
        accommodation: "Cinnamon Wild Yala",
        meals: "Breakfast, Lunch",
        activities: [
          "Morning safari",
      ...
      },
      {
        ...
        location: "Colombo",
        description:
          "Scenic coastal drive to Colombo with stop at turtle hatchery. Airport transfer.",
        meals: "Breakfast",
  ...
  },
  {
    ...
    description:
      "Discover Sri Lanka's unspoiled eastern coastline with pristine beaches, cultural sites and marine adventures in Trincomalee and Batticaloa.",
    image: "/images/home/img1.jpg",
    duration: 5,
    price: 799,
    rating: 4.7,
    ...
    itinerary: [
      {
        ...
        description:
          "Airport transfer to Trincomalee via Dambulla. Evening beach welcome ceremony.",
      ...
      },
      {
        ...
        location: "Trincomalee",
        description:
          "Morning whale watching tour. Afternoon snorkeling at Pigeon Island National Park.",
        accommodation: "Trinco Blu by Cinnamon",
        meals: "Breakfast, Lunch",
      ...
      },
      {
        ...
        location: "Trincomalee",
        description:
          "Visit Koneswaram Temple and Fort Frederick. Afternoon cooking class and fishing village tour.",
        accommodation: "Trinco Blu by Cinnamon",
        meals: "Breakfast, Dinner",
      ...
      },
      {
        ...
        location: "Batticaloa",
        description:
          "Transfer to Batticaloa. Lagoon boat tour with musical sands experience. Dutch Fort exploration.",
      ...
      },
      {
        ...
        location: "Colombo",
        description:
          "Return drive to Colombo with stop at local markets. Airport transfer.",
        meals: "Breakfast",
  ...
  },
  {
    ...
    description:
      "Rejuvenate with authentic Ayurvedic treatments, yoga sessions and mindful nature experiences in Sri Lanka's tranquil southern and hill regions.",
    image: "/images/home/img1.jpg",
    duration: 7,
    price: 1299,
    rating: 4.9,
    ...
    itinerary: [
      {
        ...
        location: "Weligama",
        description:
          "Transfer to beachside wellness resort. Ayurvedic consultation and welcome ceremony.",
      ...
      },
      {
        ...
        location: "Weligama",
        description:
          "Sunrise yoga session. Herbal compress massage. Nutrition workshop and cooking demonstration.",
        accommodation: "Santani Wellness Resort",
        meals: "All meals",
      ...
      },
      {
        ...
        location: "Weligama",
        description:
          "Guided forest bathing. Sound healing therapy. Afternoon mindfulness beach walk.",
        accommodation: "Santani Wellness Resort",
        meals: "All meals",
      ...
      },
      {
        ...
        location: "Kanneliya",
        description:
          "Scenic drive to hill retreat. Afternoon herbal garden tour and tea ceremony.",
      ...
      },
      {
        ...
        location: "Kanneliya",
        description:
          "Waterfall meditation. Hydrotherapy session. Evening yoga nidra.",
        accommodation: "The Rainforest Ecolodge",
        meals: "All meals",
      ...
      },
      {
        ...
        location: "Kanneliya",
        description:
          "Personalized wellness plan development. Final detox treatment. Farewell ceremony.",
        accommodation: "The Rainforest Ecolodge",
        meals: "All meals",
      ...
      },
      {
        ...
        location: "Colombo",
        description:
          "Transfer to airport with herbal tea hamper. Optional Colombo spa stop.",
        meals: "Breakfast",
