          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-ceylon-sand/10 rounded-xl p-6 my-10">
              ...
              <div className="flex flex-wrap gap-3">
                <Button
                  variant="secondary"
                  className="rounded-full bg-white hover:bg-ceylon-sand/20 border border-ceylon-sand/30"
                  asChild
                >
                  <a
            ...
            <section className="my-12">
              ...
              <div className="space-y-8">
                {post.comments?.map((comment) => (
                  <div
                    key={comment.id}
                    className="border-l-4 border-ceylon-tea pl-4 py-2"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center justify-between mb-2 gap-2">
                          <h4 className="font-bold text-lg text-ceylon-stone">
                            {comment.author}
                          </h4>
          ...
          <aside className="lg:col-span-1 space-y-8">
            ...
            <div className="bg-ceylon-sand/10 p-6 rounded-xl">
              <div className="flex items-center mb-5">
                ...
                <div>
                  <h3 className="font-bold text-xl text-ceylon-stone">
                    {post.author}
                  </h3>
