...
const TravelComponentManager = () => {
  ...
  const [editingComponent, setEditingComponent] =
    useState<TravelComponent | null>(null);
  ...
  const fetchComponentsByType = useCallback(
    ...
    try {
      ...
      const payload = {
        ...
        departureCoordinates:
          formData.departureCoordinates.lat && formData.departureCoordinates.lng
            ? formData.departureCoordinates
            : null,
        arrivalCoordinates:
          formData.arrivalCoordinates.lat && formData.arrivalCoordinates.lng
  ...
  const handleEdit = (component: TravelComponent) => {
    ...
    setFormData({
      ...
      departureLocation:
        (component as TransportComponent).departureLocation || "",
      arrivalLocation: (component as TransportComponent).arrivalLocation || "",
      departureCoordinates: (component as TransportComponent)
        .departureCoordinates || { lat: 0, lng: 0 },
      arrivalCoordinates: (component as TransportComponent)
        .arrivalCoordinates || { lat: 0, lng: 0 },
    });
          ...
          {component.type === "accommodations" && (
            <div className="mb-3">
              ...
              <div className="flex flex-wrap gap-1">
                {((component as AccommodationComponent).amenities || []).map(
                  (amenity, index) => (
          ...
          {component.type === "destination" && (
            <div className="mb-3">
              ...
              <ul className="list-disc pl-5 text-sm">
                {((component as DestinationComponent).attractions || []).map(
                  (attraction, index) => (
          ...
          {component.type === "transport" && (
            <div className="mb-3">
              ...
              <div className="flex items-center text-sm">
                ...
                <span className="font-medium">
                  {(component as TransportComponent).arrivalLocation}
                </span>
              </div>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Manage accommodations, destinations, activities, and transport
          </p>
        </div>
