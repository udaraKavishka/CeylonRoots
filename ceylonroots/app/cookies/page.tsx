          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            <div className="prose max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  They help us understand how visitors interact with our
                  website, remember your preferences, and show you relevant
                  content, making your browsing experience better.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  secure areas access, and remembering your preferences. The
                ...
                <p className="mb-4">
                  ...
                  visitors and see how visitors move around our website. This
                ...
                <p className="mb-4">
                  ...
                  have visited, and the links you have followed. We may use this
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  and deliver advertisements on and through the website. These
                  may include:
                </p>
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  <li>
                    Google Analytics: To analyze how users use our website
                  </li>
                  <li>
                    Google Ads and Facebook Pixel: To deliver tailored
                    advertising
                  </li>
                  <li>Payment processors: To process transactions securely</li>
                  <li>
                    Social media platforms: To enable sharing and interaction
                    features
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  settings preferences. Here&apos;s how you can manage cookies
                ...
                <p className="mb-4">
                  ...
                  experience on our website, as some features may not function
                  properly.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  banner asking for your consent to place cookies on your
                  device. You can choose to accept all cookies, only essential
