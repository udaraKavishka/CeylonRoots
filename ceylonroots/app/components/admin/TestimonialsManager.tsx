  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment:
        "Absolutely incredible experience! The cultural immersion package exceeded all my expectations. The local guides were knowledgeable and friendly.",
      image:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "The adventure package was perfectly organized. Every detail was taken care of, and the scenery was breathtaking.",
      image:
    ...
    },
    {
      ...
      rating: 5,
      comment:
        "Family trip was amazing! Kids loved every moment, and we created memories that will last a lifetime.",
      image:
