...
const Contact = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      // Email sending is best-effort; don't block user feedback
    }
      ...
      <div className="relative pt-20 h-64 md:h-80 bg-gradient-to-r from-ceylon-ocean to-ceylon-tea">
        <div className="ceylon-container h-full flex flex-col justify-center">
          ...
          <p className="text-black text-lg md:text-xl max-w-2xl">
            Have questions or ready to plan your Sri Lankan adventure? We&#39;re
      ...
      <main className="flex-grow py-12">
        <div className="ceylon-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              <h2 className="text-2xl font-semibold mb-6 text-ceylon-stone">
                Send Us a Message
              </h2>
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="ceylon-button-primary w-full md:w-auto"
                  >
