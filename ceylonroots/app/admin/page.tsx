        ...
        <div className="container mx-auto px-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add, edit, and manage your website content
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-3">
                        {[
                          ...
                          {
                            label: "Destinations",
                            value: stats.counts.destinations,
                            icon: MapPin,
                            color: "bg-green-500",
                          },
                          {
                          ...
                          <Card key={s.label} className="overflow-hidden">
                            <CardContent className="flex items-center p-3">
                              <div
                                className={`${s.color} p-2 rounded-lg mr-2 flex-shrink-0`}
                              >
                          ...
                          <ResponsiveContainer width="100%" height={280}>
                            <BarChart
                              data={[
                                {
                                  name: "Packages",
                                  count: stats.counts.packages,
                                  fill: "#3b82f6",
                                },
                                {
                                  name: "Blogs",
                                  count: stats.counts.blogs,
                                  fill: "#a855f7",
                                },
                                {
                                  name: "Destinations",
                                  count: stats.counts.destinations,
                                  fill: "#22c55e",
                                },
                                {
                                  name: "Reviews",
                                  count: stats.counts.reviews,
                                  fill: "#eab308",
                                },
                                {
                                  name: "Guides",
                                  count: stats.counts.guides,
                                  fill: "#14b8a6",
                                },
                                {
                                  name: "Gallery",
                      ...
                      {stats.topPackages.length > 0 && (
                        <Card>
                          <CardHeader>
                            <CardTitle className="text-base">
                              Top Packages by Rating
                            </CardTitle>
                          </CardHeader>
                          <CardContent>
                            <ResponsiveContainer width="100%" height={320}>
                              <RadarChart
                                data={stats.topPackages.map((p) => ({
                                  name:
                                    p.title.length > 20
                                      ? p.title.slice(0, 20) + "…"
                                      : p.title,
