...
const DestinationCard: React.FC<DestinationCardProps> = ({ destination, packageCount, onClick }) => {
        ...
        >
            ...
            <div className="flex flex-col flex-1 p-5">
                ...
                {destination.description ? (
                    ...
                    <p className="text-muted-foreground/60 italic text-sm mb-3">No description available</p>
                )}
