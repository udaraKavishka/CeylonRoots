              ...
              <div className="bg-ceylon-sand/20 backdrop-blur-sm rounded-xl p-5 border border-ceylon-sand/30">
                <div className="flex flex-wrap justify-center gap-6">
                  <div className="text-center">
                    <p className="text-xs uppercase tracking-wider text-ceylon-sand-light mb-2">
                      Stories
                    </p>
        ...
        >
          ...
          {loading ? (
            <div className="text-center py-20">
              ...
              <p className="text-ceylon-stone text-lg">
            ...
            <div className="text-center py-20">
              ...
              <h2 className="text-2xl font-bold text-ceylon-stone mb-4">
                ...
                {filteredPosts.length === 0 && (
                  <div className="text-center py-24 bg-ceylon-sand/5 rounded-2xl border border-ceylon-sand/20">
                    <div className="bg-ceylon-sand/10 w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-8">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-12 w-12 text-ceylon-tea"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                    ...
                    <p className="text-ceylon-sand max-w-md mx-auto">
                      Our writers are crafting new content. Check back soon for
                      inspiring stories!
                    </p>
                  </div>
                )}
