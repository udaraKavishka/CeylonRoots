          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-white/80">
                Get travel inspiration, exclusive offers, and insider tips
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-white/80 mb-6">
              Crafting authentic Sri Lankan travel experiences that connect you
              with the island&#39;s heart and soul.
            </p>
            <div className="flex space-x-4">
              <a
                ...
                className="text-white hover:text-ceylon-gold transition-colors"
                aria-label="Facebook"
              >
