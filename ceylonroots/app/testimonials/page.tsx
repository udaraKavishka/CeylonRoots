...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    testimonial:
      "The customized itinerary CeylonRoots created for us perfectly balanced culture, wildlife, and relaxation. Our guide was knowledgeable and friendly throughout. The safari at Yala National Park was a highlight – we saw elephants, leopards, and countless birds. The beachfront villa in Mirissa was stunning, and the team arranged a private dinner on the beach for our anniversary.",
  ...
  },
  {
    ...
    rating: 4,
    testimonial:
      "We appreciated how flexible CeylonRoots was with our schedule changes. The tea country was breathtaking and our accommodation selections were excellent. Our only suggestion would be to allow more time for the train journey from Kandy to Ella as it was a highlight of our trip. The views were spectacular, and we wished we had more time to enjoy it.",
  ...
  },
  {
    ...
    rating: 4,
    testimonial:
      "Our family of five had a wonderful two weeks exploring Sri Lanka with CeylonRoots. The itinerary was well-paced for our children (ages 8, 10, and 14), with plenty of activities to keep them engaged. The wildlife spotting was a hit - we saw elephants, monkeys, and even a leopard! The only improvement would be more family-friendly food options in some locations.",
