        ...
        <div className="ceylon-container">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600">
              Expert tips, cultural insights, and traveler stories to inspire
    ...
    <section className="py-16 bg-white" aria-label="Travel blog preview">
      <div className="ceylon-container">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-600">
            Expert tips, cultural insights, and traveler stories to inspire your
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post) => {
            ...
            return (
              <Card
                key={post.id}
                className="ceylon-card border-0 shadow-lg group"
              >
