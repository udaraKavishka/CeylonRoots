...
export const galleryItems: GalleryItem[] = [
  {
    ...
    description:
      "The ancient rock fortress and palace ruins of Sigiriya, a UNESCO World Heritage site.",
  ...
  },
  {
    ...
    description:
      "The historic Galle Fort illuminated by the golden light of sunset.",
  ...
  },
  {
    ...
    description:
      "A rare leopard sighting during a safari in Yala National Park, home to one of the highest leopard densities in the world.",
  ...
  },
  {
    ...
    description:
      "The iconic Nine Arch Bridge in Ella, surrounded by lush green tea plantations.",
    categories: ["cultural", "adventure"],
  ...
  },
  {
    ...
    description:
      "Gentle waves washing ashore on the beautiful Unawatuna Beach.",
  ...
  },
  {
    ...
    description:
      "The Temple of the Sacred Tooth Relic (Sri Dalada Maligawa) in Kandy, one of the most sacred Buddhist sites.",
    categories: ["cultural"],
  ...
  },
  {
    ...
    description:
      "Rolling hills of verdant tea plantations in Nuwara Eliya, the heart of Sri Lanka's tea country.",
  ...
  },
  {
    ...
    description:
      "Elephants enjoying a refreshing bath in the river at Pinnawala Elephant Orphanage.",
    categories: ["wildlife", "adventure"],
  ...
  },
  {
    ...
    location: "Kandy, Central Highlands",
    description:
      "The serene Kandy Lake with the Temple of the Sacred Tooth Relic in the background.",
    categories: ["cultural"],
  ...
  },
  {
    ...
    location: "Sigiriya, Cultural Triangle",
    description:
      "The famous frescoes on Sigiriya Rock, depicting celestial nymphs.",
    categories: ["cultural"],
  ...
  },
  {
    ...
    location: "Galle, Southern Coast",
    description:
      "The historic lighthouse in Galle Fort, dating back to colonial times.",
  ...
  },
  {
    ...
    description:
      "The magnificent Ruwanwelisaya Stupa, one of the world's oldest and most venerated Buddhist monuments.",
    categories: ["cultural"],
  ...
  },
  {
    ...
    location: "Colombo",
    description:
      "A colorful spread of traditional Sri Lankan rice and curry dishes.",
    categories: ["food"],
    featured: true,
  ...
  },
  {
    ...
    location: "Ella, Hill Country",
    description:
      "The breathtaking view from Little Adam's Peak at sunrise, showing mist-covered valleys below.",
  ...
  },
  {
    ...
    thumbnailUrl:
      "https://images.unsplash.com/photo-1623645481161-0d8160281cbf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
    caption: "Sea Turtles at Hikkaduwa",
    location: "Hikkaduwa, Southern Coast",
    description:
      "Sea turtles swimming in the clear waters of Hikkaduwa Marine Sanctuary.",
  ...
  },
  {
    ...
    description:
      "A herd of wild elephants grazing in Udawalawe National Park, one of the best places to see elephants in their natural habitat.",
    categories: ["wildlife"],
