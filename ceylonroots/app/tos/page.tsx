          ...
          <div className="bg-white p-8 rounded-lg shadow-sm">
            <div className="prose max-w-none">
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  By accessing or using CeylonRoots Travel&apos;s website and
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  Our services are intended for personal and non-commercial use.
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  ...
                  <li>
                    Use scraping, data mining, or automated tools to gather data
                  </li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  ...
                  <li>
                    Payment terms, including deposits and final payments, will
                    be specified during the booking process
                  </li>
                  <li>
                    All prices are subject to availability and confirmation at
                    the time of booking
                  </li>
                  <li>
                    Additional fees such as tourist taxes or resort fees may
                    apply and are your responsibility
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  <li>
                    Cancellations more than 60 days before the trip: 90% refund
                  </li>
                  <li>Cancellations 30-60 days before the trip: 50% refund</li>
                  <li>
                    Cancellations less than 30 days before the trip: No refund
                  </li>
                  <li>
                ...
                <p className="mb-4">
                  In case of extraordinary circumstances (natural disasters,
                  political unrest), we may offer rescheduling or credit for
                  future travel.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  images, and software, is the property of CeylonRoots Travel
                  and is protected by copyright and other intellectual property
                  laws. You may not:
                </p>
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  <li>
                    Reproduce, distribute, or display our content without
                    permission
                  </li>
                  <li>Modify or create derivative works from our content</li>
                  <li>
                    Use our trademarks or service marks without written
                    permission
                  </li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  When you submit content to our website (reviews, photos,
                  comments):
                </p>
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  ...
                  <li>
                    You affirm that your content does not violate any laws or
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2">
                  ...
                  <li>
                    Our liability for any claims arising from these terms is
              ...
              <section className="mb-8">
                ...
                <p className="mb-4">
                  ...
                  jurisdiction of the courts in Colombo, Sri Lanka.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="mt-8">
                  ...
                  contact us at legal@ceylonroots.com.
                </p>
              </section>
            </div>
          </div>
